    ...
    <div className="grid grid-cols-1 md:grid-cols-3 justify-center gap-5 md:gap-6 lg:gap-10 items-center w-full ">
      {buttonData.map((item) => (
        ...
        >
          ...
          <Link href={item?.link} target="_blank" className="w-1/2 md:w-2/3 lg:w-[250px] mt-2 md:mt-5 bg-white/[0.023] rounded-lg backdrop-blur-sm border-white px-2 py-3 border-[1px] text-base md:text-lg font-medium text-white  items-center bg-none text-center flex gap-3 justify-center">
