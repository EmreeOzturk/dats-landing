...
const WhySection = () => {
    return (
        <section className="flex flex-col items-center justify-between overh h-screen max-w-7xl mx-auto ">
            <div className="flex  items-center justify-between ">
                <div className="w-1/2 flex items-center justify-center">
                    <Sphere />
                </div>
                <div className="flex flex-col items-start gap-10 justify-center max-w-xl  w-1/2">
